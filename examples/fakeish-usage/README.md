# @l4n3/fakeish Usage Examples

Examples demonstrating how to use [`@l4n3/fakeish`](../../packages/fakeish) to generate mock data from Zod schemas.

`fakeish` generates realistic, randomized data that respects Zod validation constraints — useful for tests, seeding databases, or prototyping.
...
```bash
npx tsx examples/fakeish-usage/src/basic-primitives.ts
```
